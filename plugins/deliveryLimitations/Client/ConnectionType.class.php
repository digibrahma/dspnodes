 ...
 */
class Plugins_DeliveryLimitations_Client_ConnectionType extends Plugins_DeliveryLimitations_CommaSeparatedData
{
    function __construct()
    {
        parent::__construct();
        $this->nameEnglish = 'Network - Connection Type';
    }
