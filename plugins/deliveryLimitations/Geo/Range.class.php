 ...
 */
class Plugins_DeliveryLimitations_Geo_Range extends Plugins_DeliveryLimitations_CommaSeparatedData
{
    function __construct()
    {
        parent::__construct();
        $this->nameEnglish = 'Geo - Range';
    }
    ...
    function displayArrayData()
    {
		...
		$query=OA_Dal_Delivery_query("select * from djax_iprange");
		
		while($results=OA_Dal_Delivery_fetchAssoc($query))
		{
		$res[$results['locid']]=$results['name'];
		}
