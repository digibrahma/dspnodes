 ...
 *
 */
class Plugins_InvocationTags_OxInvocationTags_nbanner extends Plugins_InvocationTags
{
    ...
    function getName()
    {
        return $this->translate("N Banner Tag");
    }
  ...
  * users."),
		...
		$buffer .="<script type='text/javascript' src='http://code.jquery.com/jquery-1.11.2.min.js'></script>";
