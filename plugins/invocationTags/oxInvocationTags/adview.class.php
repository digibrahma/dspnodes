...
$buffer=$buffer.'<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js">
</script>
<script>
window.onload=function(){
	$.getScript( "http://rig.digibrahma.in/www/delivery/avw_support.php?zoneid='.$_GET["zoneid"].'" );
  }
</script>	';
        return $buffer;
    }
