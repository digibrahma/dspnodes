    ...
    function getSettingsPreferences($section)
    {
        ...
        if ($this->_optionType == 'account-settings') {
            $aSections = array(
                ...
                'plugins'         => array('name' => $GLOBALS['strPluginSettings'],         'perm' => OA_ACCOUNT_ADMIN)//DAC015-Configure SDK path
            );
        }
        
        //,'adminconfiguration' => array('name' => "Admin Configuration",'perm' => OA_ACCOUNT_ADMIN)
