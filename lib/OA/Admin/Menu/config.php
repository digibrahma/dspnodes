...
function _buildNavigation($accountType)
{
    ...
    switch ($accountType) {
       ...
       //dac041     
		$oMenu->add(new OA_Admin_Menu_Section("iplocation", 'IP Location', "account-settings-location-setup.php", false, "iplocation"));

	    $oMenu->addTo("iplocation", new OA_Admin_Menu_Section("iplocation-settings-index", 'IP Location', "account-settings-location-setup.php", false, ""));
	    
	    	    $oMenu->addTo("iplocation", new OA_Admin_Menu_Section("iprange-settings-index", 'IP Range', "account-settings-range-setup.php", false, ""));
                   
                   $oMenu->addTo("iplocation", new OA_Admin_Menu_Section("ipupload-settings-index", 'IP Range Upload', "account-settings-range-upload.php", false, ""));
        
    		$oMenu->add(new OA_Admin_Menu_Section("redirection", 'Redirection', "account-settings-redirect-setup.php", false, "redirection"));

	    $oMenu->addTo("redirection", new OA_Admin_Menu_Section("redirection-settings-index", 'Redirection', "account-settings-redirect-setup.php", false, ""));    
            

//Dac041  
	   
            $oMenu->add(new OA_Admin_Menu_Section("mobileads", 'Mobile Ads', "account-settings-mobile-zone.php", false, "mobile"));

	        $oMenu->addTo("mobileads", new OA_Admin_Menu_Section("zonesize-settings-index", 'Mobile Screen Size Settings', "account-settings-mobile-zone.php", false, ""));

                $oMenu->addTo("mobileads", new OA_Admin_Menu_Section("terawurfl-settings-index", 'Tera-WURFL Path Settings', "account-settings-tera-wurfl.php", false, ""));

                $oMenu->addTo("mobileads", new OA_Admin_Menu_Section("custom-profile-index", 'Client Custom Profile Settings', "account-settings-custom-profile.php", false, "mobile/profile"));
                
                $oMenu->addTo("mobileads", new OA_Admin_Menu_Section("mobile-details-index", 'Mobile Details Setting', "account-settings-mobile-details.php", false, "mobile/details"));
//Dac041    
        ...
        case OA_ACCOUNT_MANAGER:
            ...
            $oMenu->addTo("inventory", new OA_Admin_Menu_Section("advertiser-campaigns", 'Campaigns', "advertiser-campaigns.php", false, "inventory/advertiserAndCampaings/campaigns", null, 1, false, 'g_adv'));
                ...
                $oMenu->addTo("advertiser-campaigns", new OA_Admin_Menu_Section("campaign-redirect", 'Redirect', "campaign-redirect.php?clientid={clientid}&campaignid={campaignid}", false, "inventory/advertisersAndCampaigns/campaigns/linkedZones"));
                
                     $oMenu->addTo("advertiser-campaigns", new OA_Admin_Menu_Section("campaign-iprange", 'IP Range', "campaign-iprange.php?clientid={clientid}&campaignid={campaignid}", false, "inventory/advertisersAndCampaigns/campaigns/linkedZones"));
...
//=======================================================Modified By DAC021===============================================================//
 ...
 $oMenu->addTo("inventory", new OA_Admin_Menu_Section("campaign-mobilebanner", ' Mobile Ads', "campaign-mobilebanner.php", false, "inventory/advertisersAndCampaigns/campaigns/mobilebanners", null, 1, false, 'g_adv'));

            $oMenu->addTo("campaign-mobilebanner", new OA_Admin_Menu_Section("mobilebanner-edit_new", 'Add Mobilebanner', "mobilebanner-edit.php?clientid={clientid}&campaignid={campaignid}", true, "inventory/advertisersAndCampaigns/campaigns/mobilebanners/addMobilebanner"));

                $oMenu->addTo("campaign-mobilebanner", new OA_Admin_Menu_Section("mobilebanner-edit", 'BannerProperties', "mobilebanner-edit.php?clientid={clientid}&campaignid={campaignid}&bannerid={bannerid}", false, "inventory/advertisersAndCampaigns/campaigns/mobilebanners/editMobilebanner"));
...
//=======================================================Modified By DAC021===============================================================//
 $oMenu->addTo("inventory", new OA_Admin_Menu_Section('affiliate-mobilezones', 'Mobile Zones', 'affiliate-mobilezones.php', false, 'inventory/publishersAndZones/mobilezones', null, 1, false, 'g_website')); //g_mobizone

   $oMenu->addTo('affiliate-mobilezones', new OA_Admin_Menu_Section('mobilezone-edit_new', 'AddNewMobilezone', 'mobilezone-edit.php?affiliateid={affiliateid}', true, "inventory/publishersAndZones/mobilezones/addMobilezone"));
                $oMenu->addTo('affiliate-mobilezones', new OA_Admin_Menu_Section('mobilezone-edit', 'Mobile Zone Properties', 'mobilezone-edit.php?affiliateid={affiliateid}&zoneid={zoneid}', false, "inventory/publishersAndZones/mobilezones/editMobilezone"));
