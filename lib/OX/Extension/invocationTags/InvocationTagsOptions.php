...
class Plugins_InvocationTagsOptions
{
	...
	if($maxInvocation->codetype != "invocationTags:oxInvocationTags:vastjs" )
	{

	if($maxInvocation->codetype != "invocationTags:oxInvocationTags:videoadjs" && $maxInvocation->codetype != "invocationTags:oxInvocationTags:overlayadjs"  ) {
...
if($maxInvocation->codetype != "invocationTags:oxInvocationTags:vastjs" )
	{
if(($maxInvocation->codetype != "invocationTags:oxInvocationTags:videoadjs") && ($maxInvocation->codetype != "invocationTags:oxInvocationTags:overlayadjs") && ($maxInvocation->codetype != "invocationTags:oxInvocationTags:redirect")) {
...
if(($maxInvocation->codetype != "invocationTags:oxInvocationTags:videoadjs") && ($maxInvocation->codetype != "invocationTags:oxInvocationTags:overlayadjs") && ($maxInvocation->codetype != "invocationTags:oxInvocationTags:redirect")) {
	...
	if($maxInvocation->codetype= "invocationTags:oxInvocationTags:redirect" )
	{

        $option = '';
        $option .= "<tr><td width='30'>&nbsp;</td>";
        $option .= "<td width='200'>Redirect After</td><td width='370'>";
        $option .= "<input class='flat' type='text' name='redirect' size='' value='".(isset($maxInvocation->redirect) ? $maxInvocation->redirect : $this->defaultValues['redirect'])."' style='width:175px;' tabindex='".($maxInvocation->tabindex++)."'> ".$GLOBALS['strAbbrSeconds']."</td></tr>";
        $option .= "<tr><td width='30'><img src='" . OX::assetPath(). "/images/spacer.gif' height='5' width='100%'></td></tr>";
        return $option;
...
if(($maxInvocation->codetype != "invocationTags:oxInvocationTags:videoadjs") && ( $maxInvocation->codetype != "invocationTags:oxInvocationTags:overlayadjs") && ($maxInvocation->codetype != "invocationTags:oxInvocationTags:redirect")) {
	...
	if($maxInvocation->codetype != "invocationTags:oxInvocationTags:vastjs" && $maxInvocation->codetype != "invocationTags:oxInvocationTags:redirect" )
	{

	if(!$maxInvocation->display) {
...
if($maxInvocation->codetype != "invocationTags:oxInvocationTags:vastjs" && $maxInvocation->codetype != "invocationTags:oxInvocationTags:redirect")
	...
	if($maxInvocation->display) {
        ...
        $option .= "<tr><td width='30'>&nbsp;</td>";
	        ...
	        $option .= "<td width='200'> Player width and height<br/></td>";
	        $option .= "<td width='370'>Width : <input type='text' name='pwidth' id='pwidth' ".(isset($maxInvocation->pwidth) ? $maxInvocation->pwidth : '')." tabindex='".($maxInvocation->tabindex++)."'>&nbsp;px&nbsp;&nbsp;Height : <input type='textbox' name='pheight' id='pheight' ".(isset($maxInvocation->pheight) ? $maxInvocation->pheight : '').">&nbsp;px<br/> </td>";
		...
		$option .= "<td width='500'> <input type='radio' name='skipad' value='1'".(isset($maxInvocation->skipad) && $maxInvocation->skipad == 1 ? ' checked' : '')." tabindex='".($maxInvocation->tabindex++)."'>&nbsp;".$GLOBALS['strYes']." &nbsp; &nbsp;";
            $option .= "<input type='radio' name='skipad' value='2'".(!isset($maxInvocation->skipad) || $maxInvocation->skipad == 0 ? ' checked' : '')." tabindex='".($maxInvocation->tabindex++)."'>&nbsp;".$GLOBALS['strNo']."</td>";
 		$option .= "</tr>";

		

if($maxInvocation->codetype == "invocationTags:oxInvocationTags:videoadjs"){
		
}

if($maxInvocation->codetype == "invocationTags:oxInvocationTags:overlayadjs"){
		...
		$option .= "<tr><td width='50'>&nbsp;</td><td width='200'>Overlay ad duration  </td> ";
		$option .= "<td width='500'> <input type='text' name='adduration' id='adduration' ".(isset($maxInvocation->adduration) ? $maxInvocation->adduration : '')." tabindex='".($maxInvocation->tabindex++)."' >Seconds<br/></td></tr>";

		$option .= "<tr><td width='50'>&nbsp;</td><td width='200'>Overlay ad Position </td> ";
		$option .= "<td width='500'> <select name='oposition' tabindex='".($maxInvocation->tabindex++)."'>
                <option value=''>Default</option>
                <option value='obottom'" . ($target == 'obottom' ? " selected='selected'" : '') . ">Bottom</option>
                <option value='otop'" . ($target == 'otop' ? " selected='selected'" : '') . ">Top</option>
		<option value='ocenter'" . ($target == 'ocenter' ? " selected='selected'" : '') . ">Center</option>
            	</select> <br/></td></tr>";
