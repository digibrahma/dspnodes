...
class Plugins_InvocationTags extends OX_Component
{
	...
	/* openXmods - DAC015  */
		...
		if($mi->codetype != "invocationTags:oxInvocationTags:videoadjs" && $mi->codetype != "invocationTags:oxInvocationTags:overlayadjs") {
	...
	/* openXmods - DAC015  */
		...
		if($mi->codetype != "invocationTags:oxInvocationTags:videoadjs" && 
$mi->codetype !="invocationTags:oxInvocationTags:overlayadjs") {
	...
	/* openxmods - DAC009 */
		...
		if($mi->codetype == "invocationTags:oxInvocationTags:mobile") {
	...
	/* openxmods - DAC009 */
        ...
        if ((isset($mi->bannerid)) && ($mi->bannerid != '')) {
	     ...
	     $hrefParams[]='transaction_id={transaction_id}';//DAC015
        }
...
if($mi->codetype == "invocationTags:oxInvocationTags:mobile") {
			...
			if(mysql_num_rows($query) > 0) {
				...
				while($rowProfile = mysql_fetch_assoc($query)) {

					$limit[$i] = $rowProfile['name']."=";
			...
			if(!empty($limit))
				{
					$hrefParams = array_merge($hrefParams,$limit);
				} 
...
//===================================================Modified by DAC009==============================================================================//
		if($mi->codetype == "invocationTags:oxInvocationTags:mobile") {
			...
			if(!empty($limit))
				{
			$imgParams = array_merge($imgParams,$limit);
				} 
		}
//========================================Modified by DAC009===========================================================================================//
