...
/* openxmods - DAC009 */
   	...
   	$_zone = mysql_query("select masterzone from ".$table_prefix."zones where zoneid=".$aVariables['zone_id'])or die("Error-->in else".mysql_error());
    	$_zone_det = mysql_fetch_array($_zone);



	     if($_zone_det['masterzone'] == '-2' ){
		  
			$scrip = explode('/',$_SERVER['SCRIPT_NAME']);

			$num = count($scrip);

			if($scrip[$num - 1] == "mobilebanner-edit.php") {


						$_query = mysql_query("select * from ".$table_prefix."banners where pluginversion = '-2' and bannerid = ".$aVariables['ad_id']."")or die("Error-->2".mysql_error());

				} else {

		$_query = mysql_query("select * from ".$table_prefix."banners where masterbanner = '-2' and bannerid = ".$aVariables['ad_id']."")or die("Error-->2".mysql_error());
	   ...
	   } else if($_zone_det['masterzone'] == '-3' ){//For mobile text banner
			...
			if($scrip[$num - 1] == "mobilebanner-edit.php") {
						...
						$_query = mysql_query("select * from ".$table_prefix."banners where pluginversion = '-3' and bannerid = ".$aVariables['ad_id']."")or die("Error-->2".mysql_error());

				} else {

		$_query = mysql_query("select * from ".$table_prefix."banners where masterbanner = '-3' and bannerid = ".$aVariables['ad_id']."")or die("Error-->2".mysql_error());
	   ...
	   } else if($_zone_det['masterzone'] == '-1' ){//For mobile web banner
			...
			if($scrip[$num - 1] != "mobilebanner-edit.php") {
				...
				$_query = mysql_query("select * from ".$table_prefix."banners where masterbanner = '-1' and bannerid = ".$aVariables['ad_id']."")or die("Error-->2".mysql_error());
...
//For mobile html banner
			...
			if($scrip[$num - 1] == "mobilebanner-edit.php") {
						...
						$_query = mysql_query("select * from ".$table_prefix."banners where pluginversion = '-4' and bannerid = ".$aVariables['ad_id']."")or die("Error-->2".mysql_error());

				} else {

		$_query = mysql_query("select * from ".$table_prefix."banners where masterbanner = '-4' and bannerid = ".$aVariables['ad_id']."")or die("Error-->2".mysql_error());
