            ...
            <?php if ($this->options['strict'] || (is_array($t->aEntitiesData)  || is_object($t->aEntitiesData))) foreach($t->aEntitiesData as $e) {?><tr class="<?php echo htmlspecialchars($e['htmlclass']);?>">
				...
				<!--=========================Modified By DAC002 && DAC021==================================================-->
                    ...
                    <?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'entityLink'))) if ($t->entityLink($e['prefix'],$e['type'])) { ?><a href="<?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'entityLink'))) echo htmlspecialchars($t->entityLink($e['prefix']));?>&<?php echo htmlspecialchars($e['linkparams']);?>"><?php } else {?><span><?php }?>
					 <?php if ($e['type'])  {?>
					 		 <?php if ($e['masterbanner'])  {?>
                  			 	 <?php if ($e['name'])  {?> <img src="<?php echo htmlspecialchars($e['icon']);?>" align="absmiddle" />&nbsp;<?php echo htmlspecialchars($e['name']);?><?php } else {?><?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'tr'))) echo htmlspecialchars($t->tr("strUntitled"));?><?php }?>
							 <?php } else {?>  <?php if ($e['name'])  {?> <img src="<?php echo htmlspecialchars($t->assetPath);?>/images/spacer.gif" width="16" height="16" align="absmiddle" /> <img src="<?php echo htmlspecialchars($e['icon']);?>" align="absmiddle" />&nbsp;<?php echo htmlspecialchars($e['name']);?><?php } else {?><?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'tr'))) echo htmlspecialchars($t->tr("strUntitled"));?><?php }?><?php }?>
