<?php /* Smarty version 2.6.18, created on 2015-10-09 10:31:31
         compiled from campaign-index-list.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 't', 'campaign-index-list.html', 20, false),array('function', 'rv_add_session_token', 'campaign-index-list.html', 44, false),array('function', 'ox_column_class', 'campaign-index-list.html', 92, false),array('function', 'ox_column_title', 'campaign-index-list.html', 93, false),array('function', 'cycle', 'campaign-index-list.html', 146, false),array('function', 'ox_campaign_icon', 'campaign-index-list.html', 157, false),array('function', 'ox_entity_id', 'campaign-index-list.html', 169, false),array('function', 'ox_campaign_status', 'campaign-index-list.html', 172, false),array('function', 'ox_campaign_type', 'campaign-index-list.html', 182, false),array('modifier', 'count', 'campaign-index-list.html', 110, false),array('modifier', 'escape', 'campaign-index-list.html', 157, false),)), $this); ?>
...
'><?php echo ((is_array($_tmp=$this->_tpl_vars['campaign']['campaignname'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
		    ...
		    &nbsp;
		<?php if ($this->_tpl_vars['campaign']['status'] == 0): ?>	
		<a href='advertiser-campaigns.php?clientid=<?php echo $this->_tpl_vars['clientId']; ?>
&campaignid=<?php echo $this->_tpl_vars['campaignId']; ?>
&status=1' style="border:2px solid #fff; padding:3px; cursor:pointer;border-radius:4px; color:#fff; background-color:#34B76B;" >Pause</a>
		<?php else: ?>	
				<a href='advertiser-campaigns.php?clientid=<?php echo $this->_tpl_vars['clientId']; ?>
&campaignid=<?php echo $this->_tpl_vars['campaignId']; ?>
&status=0' style="border:2px solid #fff; padding:3px; cursor:pointer;border-radius:4px; color:#fff; background-color:#34B76B;" >
		Run<?php endif; ?>		</a>		
