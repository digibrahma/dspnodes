...
<script language='javascript' type='text/javascript' src="assets/js/jquery.multiple.select.js"></script>
<link href="assets/js/multiple-select.css" rel="stylesheet"/></link>
<script language='javascript' type='text/javascript' src="assets/js/add.js"></script>
<script type="text/javascript">

console.log('<?php echo $this->_tpl_vars['dsp_category']; ?>
');
	//$('.multiselects').multipleSelect();
	
	$('.multiselects').hide();
	//$('#dspcategory').multipleSelect();
	//$('#dspcategory').multipleSelect("setSelects", ['IAB1', 'IAB1-2']);		
	
//"setSelects", ['IAB1', 'IAB1-2']
	//"setSelects", ['IAB1', 'IAB1-2']	
