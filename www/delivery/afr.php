...
$query_val="select * from {$conf['table']['prefix']}trackers t,{$conf['table']['prefix']}campaigns_trackers c,{$conf['table']['prefix']}campaigns cl,{$conf['table']['prefix']}banners b where cl.campaignid=c.campaignid  and c.trackerid=t.trackerid  and  t.is_global='1' and c.campaignid=b.campaignid and bannerid='".$aBanner['ad_id']."'";
