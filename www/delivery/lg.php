...
$database=$conf['name'];	
		...
		{
			error_log('['.date('d-m-Y H:i:s').'] lg faild ',3,"../../../../logs/pdo.log");
			error_log(PHP_EOL,3,"../../../../logs/pdo.log");
		}
$sql 	= 	"call DailyBudgetCapping('".$aCampaignIds[0]."')";
if($dbh->query($sql))
{
		//error_log('TEst,'.$aCampaignIds[0],3,"req.log");
} 
else{ //error_log('Nt work,,',3,"req.log");
}
$dbh = null;
/*if(OA_Dal_Delivery_query("call DailyBudgetCapping('".$aCampaignIds[0]."')"))
	{
	}
  //daily budget*/
}
