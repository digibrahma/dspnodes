...
function MAX_cookieAdd1($name, $value, $expire = 50000)
{
if (!isset($GLOBALS['_MAX']['COOKIE']['CACHE'])) {
$GLOBALS['_MAX']['COOKIE']['CACHE'] = array();
}
...
function MAX_cookieClientCookieSet1($name, $value, $expire, $path = '/', $domain = null)
{
...
if (!empty($row['html'])) {
$cookie = array();
// Customization for redirect
$cookie1 = array();
$cookie[$conf['var']['adId']] = $row['bannerid'];
// Customization for redirect
$cookie1[$conf['var']['campsid']] = "#*".$row['campaignid']."!*";
if ($zoneid != 0) {
...
// Customization for redirect
MAX_cookieAdd($conf['var']['vars']."CAMP".$_GET['zoneid'] ,serialize($cookie1));
MAX_cookieFlush();
