...
//print_r($dalCampaigns); 
if(isset($_GET['campaignid']))
{
	if( $dalCampaigns->updateCampaignStatus($_GET['campaignid'], $_GET['status'], array(DataObjects_Campaigns::CAMPAIGN_TYPE_MARKET_CONTRACT)))
	{ 
		header('Location:http://staging.digibrahma.in/www/admin/advertiser-campaigns.php');
