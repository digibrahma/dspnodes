...
//=======================================================Modified By DAC021===============================================================//
			$querynew = mysql_query("select * from ".$table_prefix."banners where (masterbanner = '-3' or masterbanner = '-2' or masterbanner = '-4') and bannerid=".$bannerid) or die(mysql_error());

		if(mysql_num_rows($querynew) > 0)
		{
		    $acl = (isset($acl)) ? $acl : array();

			mobileAclSave($acl, $aEntities);
