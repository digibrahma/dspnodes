...
//=======================================================Modified By DAC021===============================================================//
	if(($row_zones['masterzone'] == -1) || ($row_zones['masterzone'] == -2))
	{
		$query = mysql_query("select * from rv_zones where masterzone =".$row_zones['zoneid']) or die(mysql_error());
		if(mysql_num_rows($query) > 0)
		{

			$aZones[$row_zones['zoneid']]['mobitype'] = 'mobile';
		} else {
			$aZones[$row_zones['zoneid']]['mobitype'] = 'web';
		}
	}
//=======================================================Modified By DAC021===============================================================//
