...
if (!empty($bannerid)) {
	...
	mysql_query("delete from rv_acls where bannerid =".$bannerid) or die(mysql_error());

	mysql_query("delete from rv_banners where masterbanner =".$bannerid) or die(mysql_error());
