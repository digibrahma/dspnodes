...
"IAB14-7"
  ...
  "user":{
    ...
    "yob":1981
		...
		/*
			...
			$requery=OA_Dal_Delivery_query("INSERT INTO  `{$table_prefix}dj_dsp_bid_request` (
				...
				VALUES (
				'".$cur_date."', '".$at."', '".$fetch_dsp['id']."','".$con_type."', '".$dev_type."', '".$dgc."', '".$geo_lat."', '".$geo_lon."', '".$geo_type."', '".$dev_ip."', '".$dev_js."', '".$dev_make."', '".$dev_model."', '".$dev_os."', '".$dev_ua."', '".$ext_udi."', '".$b_id."', '".$b_type."', '".$b_height."', '".$b_mime."', 0, '".$b_width."', '".$bid_floor."', '".$display_manager."', '".$bid."', '".$scat."', '".$s_domain."', '".$s_id."', '".$s_name."', '".$s_p_id."', '".$gender."', '".$dob."','".$data['bcat']."','".$data['badv']."','".$data['coppa']."','".$data['operaminibrowser']."')") or error_log(mysql_error(), 3, '../../../../var/query.log'); */
	...
	if($output['adtype']=='web')
	{
		...
		$djax_adm.="<beacons><beacon></beacon></beacons></imageAd></ad>"; //".$output['beacon_url']."
	}
...
//error_log(print_r($response,true),3,"error.log");
