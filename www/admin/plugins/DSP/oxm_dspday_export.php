...
if($rows>0)
{
		...
		$worksheet->write(6,1,'Campaign Name',$format4);
		$worksheet->write(6,2,'Banner Name',$format6);
		$worksheet->write(6,3,'Bid Response',$format6);
		...
		while($res=OA_Dal_Delivery_fetchAssoc($exdat))
		{
				...
				$worksheet->write($index, 1,$res['camp_name'],$format10);
				$worksheet->write($index, 2,$res['ban_name']);
